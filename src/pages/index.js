...
const IndexPage = () => {
  return <BasicLayout>
    ...
    <div className="main-tiles">
      <Link to="https://kairos-kc.churchcenter.com/calendar?view=list" className="main-tiles__tile">Upcoming Events</Link>
    ...
    <div className={'main_blurb-wrapper'}>
      <div className={'main_blurb-title'}>Kairos Church is located in Grandview, MO</div>
